...
- A recluse living in Trapper’s Cabin ...  
...
4. Mod Options:  
   ...
   * **Default PLUS:** Add items **in addition** to the default starting items  
     ...
     * Example: you want the standard starting gear PLUS a hatchet and some Ketchup Chips  
...
- Not all DLC food items have been included, because there are so many. Items such as canned corn, potatoes, salt, and flour are included. However, final products for cooked recipe cards (soups, pies, etc.) are **not** included. These may be added in the future.  

- If you encounter any issues, please report them on the **Modding Discord server** in the **#moosemeat** channel.  
