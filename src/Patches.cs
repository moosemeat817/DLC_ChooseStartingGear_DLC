...
namespace DLC_ChooseStartingGear_DLC
{
    ...
    {
        GEAR_BasicGloves, GEAR_FleeceMittens, GEAR_SkiGloves, GEAR_Mittens, GEAR_MittenBrownStripe, GEAR_MittenBlueStripe, GEAR_MittenBurgundyPattern, GEAR_TacticalGloves
    }
    public enum RandomAccessoriesInner
    {
        GEAR_EarMuffs, GEAR_RifleScabbardA, GEAR_Toolbelt, GEAR_ImprovisedDownInsulation
    }
    public enum RandomLegsOuter
    {
        GEAR_CargoPants, GEAR_CombatPants, GEAR_Jeans, GEAR_InsulatedPants, GEAR_WorkPants, GEAR_MinersPants, GEAR_WolfSkinPant
    }
    ...
    {
        GEAR_CombatBoots, GEAR_InsulatedBoots, GEAR_LeatherShoes, GEAR_MuklukBoots, GEAR_BasicShoes, GEAR_SkiBoots, GEAR_BasicBoots, GEAR_WorkBoots, GEAR_MinersBoots
    }
    class Patches
    {
